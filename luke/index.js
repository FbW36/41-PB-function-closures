...
function calculateMoneySaved(age, retirementAge, monthWage, percentSaved) {
  if (age >= retirementAge) {
    console.log(`You're already retired!`);
  } else {
    let yearsRemaining = retirementAge - age;
    let amount = monthWage * 12 * yearsRemaining;
...
console.log(calculateMoneySaved(40, 65, 2000, 5));
